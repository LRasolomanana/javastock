...
public class VueGestionTypeEpreuve extends JFrame {
    ...
    public VueGestionTypeEpreuve() {
        setTitle("🏆 Gestion des Types d'Épreuve - JavaStocks");
        setSize(500, 450);
        ...
        // --- Titre ---
        JLabel lblTitre = new JLabel("Liste des Épreuves", SwingConstants.CENTER);
        lblTitre.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitre.setBorder(BorderFactory.createEmptyBorder(15, 0, 15, 0));
        add(lblTitre, BorderLayout.NORTH);

        // --- Tableau ---
        tableModel = new DefaultTableModel(new String[]{"ID Épreuve", "Nom de l'épreuve"}, 0) {
            @Override
        ...
        btnAjouter = new JButton("AJOUTER UNE ÉPREUVE");
    ...
    public void ajouterLigneTableau(int id, String nom) { tableModel.addRow(new Object[]{id, nom}); }
